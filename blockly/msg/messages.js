...
/// gopigo drive forward
Blockly.Msg.GOPIGO_DRIVE_FORWARD = 'drive forward';
/// gopigo drive backward
Blockly.Msg.GOPIGO_DRIVE_BACKWARD = 'drive forward';
/// gopigo drive for
Blockly.Msg.GOPIGO_DRIVE_FOR = 'for';
/// gopigo set speed to
Blockly.Msg.GOPIGO_SET_SPEED_TO = 'set speed to';
/// gopigo set speed to slowest
Blockly.Msg.GOPIGO_SET_SPEED_TO_SLOWEST = 'set speed to slowest';
/// gopigo set speed to slow
Blockly.Msg.GOPIGO_SET_SPEED_TO_SLOW = 'set speed to slow';
/// gopigo set speed to normal
Blockly.Msg.GOPIGO_SET_SPEED_TO_NORMAL = 'set speed to normal';
/// gopigo set speed to fast
Blockly.Msg.GOPIGO_SET_SPEED_TO_FAST = 'set speed to fast';
/// gopigo set speed to fastest
Blockly.Msg.GOPIGO_SET_SPEED_TO_FASTEST = 'set speed to fastest';
/// gopigo turn
Blockly.Msg.GOPIGO_TURN = 'turn';
/// gopigo left
...
/// gopigo wait
Blockly.Msg.GOPIGO_WAIT = "wait";
/// gopigo secs and then...
Blockly.Msg.GOPIGO_WAIT_SECS_AND_THEN = "second(s) and then...";
/// gopigo stop
Blockly.Msg.GOPIGO_STOP = "stop";
///gopigo left blinker
Blockly.Msg.GOPIGO_TURN_LEFT_BLINKER = 'turn left blinker';
///gopigo right blinker
Blockly.Msg.GOPIGO_TURN_RIGHT_BLINKER = 'turn right blinker';
///gopigo both blinkers
Blockly.Msg.GOPIGO_TURN_BOTH_BLINKERS = 'turn both blinkers';
///gopigo blinker on
Blockly.Msg.GOPIGO_BLINKER_ON = 'on';
///gopigo blinker off
Blockly.Msg.GOPIGO_BLINKER_OFF = 'off';
//gopigo set servo to
Blockly.Msg.GOPIGO_SET_SERVO_TO = 'set servo to';
//gopigo center servo
Blockly.Msg.GOPIGO_CENTER_SERVO = 'center servo';
///gopigo take a picture
Blockly.Msg.GOPIGO_TAKE_A_PICTURE = 'take a picture';
